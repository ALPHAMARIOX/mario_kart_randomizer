...
char = ['Mario', 'Luigi', 'Peach', 'Daisy', 'Yoshi', 'Red Yoshi', 'Blue Yoshi', 'Light-Blue Yoshi', 'Yellow Yoshi', 'Pink Yoshi', 'Black Yoshi', 'White Yoshi', 'Orange Yoshi', 'Toad', 'Koopa Troopa', 'Shy Guy',
        ...
        'Tanooki Mario', 'Cat Peach', 'Link', 'Villager Male', 'Villager Female', 'Isabelle', 'Dry Bowser', 'King Boo', 'Gold Mario', 'Dry Bones', 'Bowser Jr.', 'Inkling Girl', 'Lime Inkling Girl',
        'Magenta Inkling Girl', 'Inkling Boy', 'Purple Inkling Boy', 'Cyan Inkling Boy']
...
body = ['Standard Kart', 'Pipe Frame', 'Mach 8', 'Steel Driver', 'Cat Cruiser', 'Circuit Special', 'Tri-Speeder', 'Badwagon', 'Prancer', 'Biddybuggy (Buggybud)', 'Landship', 'Sneeker (Bounder)',
        ...
        'Teddy Buggy', 'Bone Rattler', 'Koopa Clown', 'Splat Buggy', 'Inkstriker']
...
print('Thank you for using the Mario Kart 8 Deluxe Randomizer.')